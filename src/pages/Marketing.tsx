...
import { Megaphone, Send, Info, Tag, Trash2, CheckCircle, Clock } from 'lucide-react';
import { collection, addDoc, serverTimestamp, query, onSnapshot, deleteDoc, doc, where } from 'firebase/firestore';
